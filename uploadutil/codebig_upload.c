...
/**
 * @brief CodeBig upload with authorization (Internal helper for legacy API)
 */
...
/**
 * @brief Upload file using CodeBig workflow (deprecated)
 * @deprecated Use performCodeBigMetadataPost + performCodeBigS3Put for separate stage control
 */
